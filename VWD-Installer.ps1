...
Clear-Host
Write-Host "$([char]27)[38;2;140;0;255m__     ____        ____    ____  _____ ____   ____  _   _ _     _____ ____  $([char]27)[0m"
Write-Host "$([char]27)[38;2;185;0;225m\ \   / /\ \      / /  _ \  |  _ \| ____/ ___| |  _ \| | | | |   | ____/ ___| $([char]27)[0m"
Write-Host "$([char]27)[38;2;230;0;150m \ \ / /  \ \ /\ / /| | | | | |_) |  _|| |     | |_) | | | | |   |  _| \___ \ $([char]27)[0m"
Write-Host "$([char]27)[38;2;115;110;200m  \ V /    \ V  V / | |_| | |  _ <| |__| |___  |  _ <| |_| | |___| |___ ___) |$([char]27)[0m"
Write-Host "$([char]27)[38;2;0;220;255m   \_/      \_/\_/  |____/  |_| \_\_____\____| |_| \_\\___/|_____|_____|____/ $([char]27)[0m"
Write-ColoredLine ""
...
Write-ColoredLine "https://discord.gg/dt8pktqYe7" White
Write-ColoredLine ""
Write-ColoredLine "=== Credits ===" Yellow
$name = "@callmezoes"
$galaxyName = ""
for ($i = 0; $i -lt $name.Length; $i++) {
    $ratio = $i / ($name.Length - 1)
    
    # Công thức tính dải màu Galaxy mượt mà
    $R = [math]::Round(128 + 127 * [math]::Sin($ratio * [math]::PI))
    $G = [math]::Round(0 + 200 * [math]::Sin($ratio * [math]::PI / 2))
    $B = 255
    
    $galaxyName += "$([char]27)[38;2;$R;$G;${B}m$($name[$i])"
}
Write-Host "Made by $galaxyName$([char]27)[0m"
Write-Host ""
